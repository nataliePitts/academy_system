...
var mylogDB = function(req, res, next) {
    ...
    var path = req.path;
    var runmode = req.global.academyLog_db;
...
global.academy_db =  mongoose.createConnection('mongodb://localhost:27017/academy', { useNewUrlParser: true, useUnifiedTopology: true });
//Connecting to Academy Log DB + global var >>
global.academyLog_db = mongoose.createConnection('mongodb://localhost:27017/academylog',{ useNewUrlParser: true, useUnifiedTopology: true });
